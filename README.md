...
|   |Output is  a `.html` file with the following columns. It can be downloaded from ASC to local and [viewed](s4b_project/RNASeq_Data/FastQC/4040-KH-17.4040-KH-17_0_filtered_R1_fastqc.html)
in a web browser. |
|---|---|
